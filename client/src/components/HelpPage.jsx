    ...
    <div className="help-page">
      <div className="help-page__header">
        <div className="help-page__nav">
          ...
          <h1 className="help-page__title">Справка</h1>
        </div>
      </div>

      <div className="help-page__content">
        <div className="help-page__card" itemScope itemType="https://schema.org/SoftwareApplication">
          ...
          <div className="help-page__section help-page__section--auth">
          ...
          <div className="help-page__section" itemScope itemType="https://schema.org/FAQPage">
            <h3>Горячие клавиши для быстрой работы</h3>
            <div className="help-page__hotkeys">
              <div className="help-page__hotkey-item" itemProp="mainEntity" itemScope itemType="https://schema.org/Question">
                <meta itemProp="name" content="Какая клавиша для кисти?" />
                <span className="help-page__hotkey-key" itemProp="acceptedAnswer" itemScope itemType="https://schema.org/Answer"><meta itemProp="text" content="B" />B</span>
                <span className="help-page__hotkey-desc">— Кисть</span>
              </div>
              <div className="help-page__hotkey-item" itemProp="mainEntity" itemScope itemType="https://schema.org/Question">
                <meta itemProp="name" content="Какая клавиша для ластика?" />
                <span className="help-page__hotkey-key" itemProp="acceptedAnswer" itemScope itemType="https://schema.org/Answer"><meta itemProp="text" content="E" />E</span>
                <span className="help-page__hotkey-desc">— Ластик</span>
              </div>
              <div className="help-page__hotkey-item" itemProp="mainEntity" itemScope itemType="https://schema.org/Question">
                <meta itemProp="name" content="Какая клавиша для линии?" />
                <span className="help-page__hotkey-key" itemProp="acceptedAnswer" itemScope itemType="https://schema.org/Answer"><meta itemProp="text" content="L" />L</span>
                <span className="help-page__hotkey-desc">— Линия</span>
              </div>
              <div className="help-page__hotkey-item" itemProp="mainEntity" itemScope itemType="https://schema.org/Question">
                <meta itemProp="name" content="Какая клавиша для прямоугольника?" />
                <span className="help-page__hotkey-key" itemProp="acceptedAnswer" itemScope itemType="https://schema.org/Answer"><meta itemProp="text" content="R" />R</span>
                <span className="help-page__hotkey-desc">— Прямоугольник</span>
              </div>
              <div className="help-page__hotkey-item" itemProp="mainEntity" itemScope itemType="https://schema.org/Question">
                <meta itemProp="name" content="Какая клавиша для круга?" />
                <span className="help-page__hotkey-key" itemProp="acceptedAnswer" itemScope itemType="https://schema.org/Answer"><meta itemProp="text" content="C" />C</span>
                <span className="help-page__hotkey-desc">— Круг</span>
              </div>
              <div className="help-page__hotkey-item" itemProp="mainEntity" itemScope itemType="https://schema.org/Question">
                <meta itemProp="name" content="Какая клавиша для текста?" />
                <span className="help-page__hotkey-key" itemProp="acceptedAnswer" itemScope itemType="https://schema.org/Answer"><meta itemProp="text" content="T" />T</span>
                <span className="help-page__hotkey-desc">— Текст</span>
              </div>
              <div className="help-page__hotkey-item" itemProp="mainEntity" itemScope itemType="https://schema.org/Question">
                <meta itemProp="name" content="Какая клавиша для сетки?" />
                <span className="help-page__hotkey-key" itemProp="acceptedAnswer" itemScope itemType="https://schema.org/Answer"><meta itemProp="text" content="G" />G</span>
                <span className="help-page__hotkey-desc">— Включить/выключить сетку</span>
              </div>
              <div className="help-page__hotkey-item" itemProp="mainEntity" itemScope itemType="https://schema.org/Question">
                <meta itemProp="name" content="Как отменить действие?" />
                <span className="help-page__hotkey-key" itemProp="acceptedAnswer" itemScope itemType="https://schema.org/Answer"><meta itemProp="text" content="Ctrl+Z" />Ctrl+Z</span>
                <span className="help-page__hotkey-desc">— Отменить действие</span>
              </div>
              <div className="help-page__hotkey-item" itemProp="mainEntity" itemScope itemType="https://schema.org/Question">
                <meta itemProp="name" content="Как повторить действие?" />
                <span className="help-page__hotkey-key" itemProp="acceptedAnswer" itemScope itemType="https://schema.org/Answer"><meta itemProp="text" content="Ctrl+Y или Ctrl+Shift+Z" />Ctrl+Y</span>
                <span className="help-page__hotkey-desc">— Повторить действие</span>
              </div>
              <div className="help-page__hotkey-item" itemProp="mainEntity" itemScope itemType="https://schema.org/Question">
                <meta itemProp="name" content="Как увеличить масштаб?" />
                <span className="help-page__hotkey-key" itemProp="acceptedAnswer" itemScope itemType="https://schema.org/Answer"><meta itemProp="text" content="+ или Ctrl++" />+</span>
                <span className="help-page__hotkey-desc">— Увеличить масштаб</span>
              </div>
              <div className="help-page__hotkey-item" itemProp="mainEntity" itemScope itemType="https://schema.org/Question">
                <meta itemProp="name" content="Как уменьшить масштаб?" />
                <span className="help-page__hotkey-key" itemProp="acceptedAnswer" itemScope itemType="https://schema.org/Answer"><meta itemProp="text" content="- или Ctrl+-" />-</span>
                <span className="help-page__hotkey-desc">— Уменьшить масштаб</span>
              </div>
            </div>
          </div>
          ...
          <div className="help-page__section">
            <p className="help-page__copyright">
          ...
          <div className="help-page__actions">
            ...
            <button
              className="help-page__btn help-page__btn--secondary"
