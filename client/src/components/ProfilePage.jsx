        ...
        <div className="profile-content">
          ...
          <div className="profile-right">
            ...
            <div className="profile-actions">
              ...
              <button
                className={`profile-action-btn ${userState.incomingPersonalMessages.length > 0 ? 'notification' : ''}`}
              ...
              >
                ...
                {userState.incomingPersonalMessages.length > 0 && (
                  <span className="message-badge">{userState.incomingPersonalMessages.length}</span>
                )}
              </button>
            </div>
